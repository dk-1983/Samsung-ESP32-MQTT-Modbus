...
Для 0.4.0 выполнены программные тесты и сборка; новые веб-настройки, MQTT-брокер,
физический RS485 и полный цикл GitHub OTA ещё требуют проверки на устройстве.
