...
MIT notice retained in HAIER-LICENSE. The historical haier_bridge namespace is kept to
make provenance and the MIT transport core (Samsung adds a backend function-code allowlist) explicit. No hOn driver is included.
...
no private key or private Haier configuration was copied. Banner supplied by the user.
